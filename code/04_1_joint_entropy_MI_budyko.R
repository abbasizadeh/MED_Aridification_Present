...
colume_names = c("kg_code", "entropy", "number", "max_possible_entropy", "mutual_information")
...
for(kg_ite in 1:length(med_kg_codes)){
  ...
  # joint entropy
  entropy_data_frame$entropy[kg_ite] <- entropy(freq_tbl)
  ...
  # mutual entropy
  entropy_data_frame$mutual_information[kg_ite]  <- H1 + H2- entropy_data_frame$entropy[kg_ite]
...
saveRDS(budyko_data, "~/shared/data_projects/med_datasets/2000_2019_data/sim/budyko/evaporative_aridity_indices/budyko_data_04_1.rds")
